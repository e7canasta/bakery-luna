...
Thin wrapper around bakery-exporters for pose estimation models.
...
def main():
    ...
    parser = create_base_parser(
        "Export YOLO Pose Estimation models",
    )
    ...
    print("🎯 Bakery - Export Pipeline (Pose Estimation)")
    print("=" * 70)
    ...
    all_results = pipeline.export_batch(
        yolo_version,
        model_sizes,
        "pose",  # Task is always pose for this script
        resolutions,
        formats,
        args.dry_run
    )
