...
For information about the underlying video decoding system, see [Video Sources and Multiplexing](https://deepwiki.com/roboflow/inference/4.2-video-sources-and-buffer-management). For workflow-based inference instead of direct model inference, see [Workflow Execution](https://deepwiki.com/roboflow/inference/3.3-workflow-execution-engine). For batch processing of static images, see [HTTP API Server](https://deepwiki.com/roboflow/inference/2.1-http-api-server).
...
graph TD
    ...
    subgraph "InferencePipeline Core"
        MUX["multiplex_videos() - Frame Synchronization"]
        IT["Inference Thread - _run_inference_thread_loop() - Batch Collection"]
        MODEL["Model Execution - on_video_frame() - GPU/CPU Processing"]
        QUEUE["predictions_queue - Queue(maxsize=N)"]
        DT["Dispatch Thread - _consume_prediction() - Result Distribution"]
    end

    subgraph "Sink Layer"
        SINK1["on_prediction - User Callback"]
        AL["active_learning_sink - Background Upload"]
        RENDER["render_boxes - Visualization"]
        UDP["UDPSink - Network Broadcast"]
    end

    subgraph "Monitoring"
        WD["PipelineWatchDog - Latency & Throughput"]
        HANDLERS["status_update_handlers - Event Callbacks"]
    end
    ...
    class VS1,VS2,VSN,MUX,IT,MODEL,QUEUE,DT,SINK1,AL,RENDER,UDP,WD,HANDLERS layer
```
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py85-1050](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L85-L1050)
...
```mermaid
graph TD
    REF["video_reference (str|int|List)"]
    ...
    %% Estilo opcional
    classDef process fill:#eef,stroke:#666,stroke-width:2px
    class REF,PREP,SINGLE,MULTI,PIPE process
```

**Component: Video Source Selection Strategy**

The `prepare_video_sources()` function in [inference/core/interfaces/stream/utils.py52-107](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/utils.py#L52-L107) initializes sources and sets appropriate buffer strategies. Files default to `BufferFillingStrategy.WAIT` with `BufferConsumptionStrategy.LAZY` to process all frames. Streams default to `BufferFillingStrategy.ADAPTIVE_DROP_OLDEST` with `BufferConsumptionStrategy.EAGER` for low latency.

**Sources:** [inference/core/interfaces/stream/inference_pipeline.py621-723](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L621-L723) [inference/core/interfaces/stream/utils.py239-349](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/utils.py#L239-L349)
...
sequenceDiagram
    ...
    VS ->> IT: read_frame(timeout)
    IT ->> VS: VideoFrame
    IT ->> IT: collect batch
    IT ->> MODEL: call(frames)
    MODEL ->> IT: predictions
    IT ->> QUEUE: put((frames, predictions))
    DT ->> QUEUE: get()
    QUEUE ->> DT: (frames, predictions)
    DT ->> SINK: call(predictions, frames)
    SINK ->> DT: return
```

**Sequence: Frame Processing Flow**

The inference thread blocks on `batch_collection_timeout` when collecting frames from multiple sources [inference/core/interfaces/stream/inference_pipeline.py774-793](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L774-L793) If timeout expires, it proceeds with partial batches to maintain throughput.

**Sources:** [inference/core/interfaces/stream/inference_pipeline.py731-871](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L731-L871) [inference/core/interfaces/camera/video_source.py667-721](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/camera/video_source.py#L667-L721)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py79-83](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L79-L83) [inference/core/interfaces/stream/sinks.py321-367](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/sinks.py#L321-L367)
...
**Sources:** [inference/core/interfaces/stream/watchdog.py80-258](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/watchdog.py#L80-L258) [inference/core/interfaces/stream/inference_pipeline.py873-906](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L873-L906)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py86-308](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L86-L308)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py310-456](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L310-L456)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py458-641](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L458-L641)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py643-786](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L643-L786)
...
**Sources:** [inference/core/interfaces/stream/entities.py24-98](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/entities.py#L24-L98) [inference/core/interfaces/stream/inference_pipeline.py244-252](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L244-L252)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py106-114](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L106-L114) [inference/core/env.py23-24](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/env.py#L23-L24)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py160-169](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L160-L169) [inference/core/interfaces/camera/utils.py46-97](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/camera/utils.py#L46-L97)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py908-1050](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L908-L1050)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py731-871](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L731-L871)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py873-906](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L873-L906)
...
**Sources:** [inference/core/interfaces/camera/utils.py239-325](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/camera/utils.py#L239-L325) [inference/core/interfaces/stream/inference_pipeline.py210-219](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L210-L219)
...
**Sources:** [inference/core/interfaces/camera/utils.py420-447](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/camera/utils.py#L420-L447) [inference/core/interfaces/stream/inference_pipeline.py791-804](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L791-L804)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py854-871](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L854-L871) [inference/core/interfaces/stream/sinks.py116-153](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/sinks.py#L116-L153)
...
**Sources:** [inference/core/interfaces/stream/inference_pipeline.py257-291](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L257-L291) [inference/core/interfaces/stream/sinks.py369-404](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/sinks.py#L369-L404)
...
**Sources:** [inference/core/interfaces/stream/sinks.py40-196](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/sinks.py#L40-L196)
...
**Sources:** [tests/inference/unit_tests/core/interfaces/stream/test_interface_pipeline.py143-235](https://github.com/roboflow/inference/blob/77b91b3b/tests/inference/unit_tests/core/interfaces/stream/test_interface_pipeline.py#L143-L235)
...
**Sources:** [inference/core/interfaces/stream/watchdog.py200-258](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/watchdog.py#L200-L258) [tests/inference/unit_tests/core/interfaces/stream/test_watchdog.py201-250](https://github.com/roboflow/inference/blob/77b91b3b/tests/inference/unit_tests/core/interfaces/stream/test_watchdog.py#L201-L250)
...
**Sources:** [inference/core/env.py15-25](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/env.py#L15-L25) [inference/core/interfaces/stream/inference_pipeline.py15-25](https://github.com/roboflow/inference/blob/77b91b3b/inference/core/interfaces/stream/inference_pipeline.py#L15-L25)



### On this page

- [InferencePipeline](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#inferencepipeline)
- [Purpose and Scope](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#purpose-and-scope)
- [Architecture Overview](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#architecture-overview)
- [Core Components](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#core-components)
- [Video Source Management](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#video-source-management)
- [Threading Model](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#threading-model)
- [Sink Pattern](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#sink-pattern)
- [Watchdog and Status Updates](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#watchdog-and-status-updates)
- [Initialization Methods](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#initialization-methods)
- [init() - Roboflow Models](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#init---roboflow-models)
- [init_with_yolo_world() - Zero-Shot Detection](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#init_with_yolo_world---zero-shot-detection)
- [init_with_workflow() - Workflow Execution](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#init_with_workflow---workflow-execution)
- [init_with_custom_logic() - Custom Inference Functions](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#init_with_custom_logic---custom-inference-functions)
- [Configuration Parameters](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#configuration-parameters)
- [Post-Processing Configuration](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#post-processing-configuration)
- [Buffer and Queue Configuration](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#buffer-and-queue-configuration)
- [FPS Limiting](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#fps-limiting)
- [Execution Flow](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#execution-flow)
- [Pipeline Lifecycle](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#pipeline-lifecycle)
- [Inference Thread Loop](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#inference-thread-loop)
- [Dispatch Thread Loop](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#dispatch-thread-loop)
- [Multi-Source Processing](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#multi-source-processing)
- [Batch Collection Timeout](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#batch-collection-timeout)
- [Stream Reconnection](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#stream-reconnection)
- [Sink Modes](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#sink-modes)
- [SEQUENTIAL Mode](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#sequential-mode)
- [BATCH Mode](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#batch-mode)
- [ADAPTIVE Mode (Default)](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#adaptive-mode-default)
- [Active Learning Integration](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#active-learning-integration)
- [Built-in Sinks](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#built-in-sinks)
- [render_boxes()](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#render_boxes)
- [UDPSink](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#udpsink)
- [VideoFileSink](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#videofilesink)
- [InMemoryBufferSink](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#inmemorybuffersink)
- [Example Usage Patterns](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#example-usage-patterns)
- [Basic Video File Processing](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#basic-video-file-processing)
- [Real-Time Stream with Visualization](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#real-time-stream-with-visualization)
- [Multi-Source Processing with Custom Sink](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#multi-source-processing-with-custom-sink)
- [Workflow-Based Processing](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#workflow-based-processing)
- [Performance Monitoring](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#performance-monitoring)
- [Environment Variables](https://deepwiki.com/roboflow/inference/4.1-inferencepipeline#environment-variables)
